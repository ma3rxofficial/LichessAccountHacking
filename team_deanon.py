...
def start():
    answer = input(cyan + "Выберите режим [multipart/DEFAULT]: " + white)

    if answer == "":
        deanon_default(team=input(magenta + "[?] ID команды: " + white))
        ...
        deanon_multipart(team_list=input(magenta + "Введите список клубов(через пробел): " + white))
